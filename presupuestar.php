...
<div class="contindex">
 ...
 echo '<form action="modificar_guardar.php?numOrden='.$aux.'"" method="post">
            ...
            <div class="contrep">
                ...
                $ <input type="number" name="costoRepuesto" id="costoRepuesto" placeholder="123.4" min="0" step="any">
            </div>
            <br>
            <label for="costoTotal">Costo total de la reparacion:</label>
            <input type="number" name="costoTotal" id="costoTotal" title="Costo de la mano de obra + costo de repuesto"  placeholder="123.4" min="0" step="any"><br><br>
